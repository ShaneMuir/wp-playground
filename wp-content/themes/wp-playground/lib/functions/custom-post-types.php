...
/* Example - Recipe
function setup_recipe_custom_post_type() {
    ...
    $args = array(
        ...
        'show_in_rest'       => true, 
        'menu_icon'          => 'dashicons-drumstick' // https://developer.wordpress.org/resource/dashicons/#video-alt2
    );
      
    register_post_type( 'Recipe', $args );

}
add_action('init', 'setup_recipe_custom_post_type'); */
